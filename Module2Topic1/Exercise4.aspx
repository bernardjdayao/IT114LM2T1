...
<body>
    ...
    <form runat="server">
        ...
        <asp:RequiredFieldValidator ID="rfvcandidate" runat="server" ControlToValidate ="fullName" ErrorMessage="Please enter your full name">
        ...
        <asp:RangeValidator ID="rvclass" runat="server" ControlToValidate="age" ErrorMessage="Enter your class (0 - 100)" MaximumValue="100" MinimumValue="0" Type="Integer">
        </asp:RangeValidator>
        ...
        <asp:RegularExpressionValidator runat="server" ID="regexValidator" ControlToValidate="email"
